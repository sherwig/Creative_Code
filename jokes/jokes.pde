...
void loadData() {
  ...
  for (int i = 0; i<jokesData.size(); i++) {
    ...
    {
      x= jokey.getInt("freqX");
      y=jokey.getInt("freqY");
      z=jokey.getInt("freqZ");
      phiX2=jokey.getInt("phiX");
      phiY2=jokey.getInt("phiY");
      freqX=x;
      freqY=y;
      freqZ=z;
      phiX=phiX2;
      phiY=phiY2;
      // println("here");
      println("freqX: " + freqX + ", freqY: " + freqY + ", freqZ: " + freqZ + ", phiX: " + phiX2 + ", phiY: " + phiY2);
    ...
    // if (part=="single")
    // {
    //   String label = jokey.getString("joke");
    //   println(label);
    // }
